            ...
            <div class="modal-body">
                <form id="form-datos">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nit" maxlength="15" name="nit" required="required">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="direccion" maxlength="40" name="direccion" required="required">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Telefono</label>
                        <input type="number" class="form-control" id="telefono" name="telefono" maxlength="10" required="required">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="barrio" name="barrio" required="required">
                    </div>
                    <div class="form-group">
